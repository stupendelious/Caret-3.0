...
public final class API {
  ...
  public API(TransactionProcessor transactionProcessor,
    ...
    if (enableAPIServer) {
      ...
      apiHandler.addServlet(peerServletHolder, "/caret");

      if (propertyService.getBoolean(Props.JETTY_API_GZIP_FILTER)) {
        FilterHolder gzipFilterHolder = apiHandler.addFilter(GzipFilter.class, "/caret", null);
      ...
      if (propertyService.getBoolean(Props.JETTY_API_DOS_FILTER)) {
        FilterHolder dosFilterHolder = apiHandler.addFilter(DoSFilter.class, "/caret", null);
