...
public class GetAssetTransfersTest extends AbstractUnitTest {
  ...
  @Test
  public void processRequest_byAsset() throws CaretException {
    ...
    CaretIterator<AssetTransfer> mockAssetTransferIterator = mockCaretIterator(mockAssetTransfer);
  ...
  @Test
  public void processRequest_byAccount() throws CaretException {
  ...
  @Test
  public void processRequest_byAccountAndAsset() throws CaretException {
    final long assetId = 123L;
    final long accountId = 234L;
    final int firstIndex = 0;
    final int lastIndex = 1;
