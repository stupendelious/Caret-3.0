...
public interface Attachment extends Appendix {
  ...
  abstract class AbstractAttachment extends AbstractAppendix implements Attachment {
    ...
    @Override
    public final void validate(Transaction transaction) throws CaretException.ValidationException {
  ...
  final class PaymentMultiOutCreation extends AbstractAttachment {
    ...
    PaymentMultiOutCreation(ByteBuffer buffer, byte transactionVersion) throws CaretException.NotValidException {
      super(buffer, transactionVersion);
      ...
      for (int i = 0; i < numberOfRecipients; ++i) {
        ...
        if (recipientOf.containsKey(recipientId))
          throw new CaretException.NotValidException("Duplicate recipient on multi out transaction");

        if (amountNQT <= 0)
          throw new CaretException.NotValidException("Insufficient amountNQT on multi out transaction");
      ...
      if (recipients.size() > Constants.MAX_MULTI_OUT_RECIPIENTS || recipients.size() <= 1) {
        throw new CaretException.NotValidException(
            "Invalid number of recipients listed on multi out transaction");
      }
    }

    PaymentMultiOutCreation(JSONObject attachmentData) throws CaretException.NotValidException {
      super(attachmentData);
    ...
    public PaymentMultiOutCreation(Collection<Entry<String, Long>> recipients, int blockchainHeight) throws CaretException.NotValidException {
      super(blockchainHeight);
  ...
  final class PaymentMultiSameOutCreation extends AbstractAttachment {
    ...
    PaymentMultiSameOutCreation(ByteBuffer buffer, byte transactionVersion) throws CaretException.NotValidException {
      super(buffer, transactionVersion);
      ...
      for (int i = 0; i < numberOfRecipients; ++i) {
        ...
        if (recipientOf.containsKey(recipientId))
          throw new CaretException.NotValidException("Duplicate recipient on multi same out transaction");
    ...
    PaymentMultiSameOutCreation(JSONObject attachmentData) throws CaretException.NotValidException {
      super(attachmentData);
    ...
    public PaymentMultiSameOutCreation(Collection<Long> recipients, int blockchainHeight) throws CaretException.NotValidException {
      super(blockchainHeight);
  ...
  class MessagingAliasAssignment extends AbstractAttachment {
    ...
    MessagingAliasAssignment(ByteBuffer buffer, byte transactionVersion) throws CaretException.NotValidException {
      super(buffer, transactionVersion);
  ...
  class MessagingAliasSell extends AbstractAttachment {
    ...
    MessagingAliasSell(ByteBuffer buffer, byte transactionVersion) throws CaretException.NotValidException {
      super(buffer, transactionVersion);
  ...
  final class MessagingAliasBuy extends AbstractAttachment {
    ...
    MessagingAliasBuy(ByteBuffer buffer, byte transactionVersion) throws CaretException.NotValidException {
      super(buffer, transactionVersion);
      this.aliasName = Convert.readString(buffer, buffer.get(), Constants.MAX_ALIAS_LENGTH);
    }
  ...
  final class MessagingAccountInfo extends AbstractAttachment {
    ...
    MessagingAccountInfo(ByteBuffer buffer, byte transactionVersion) throws CaretException.NotValidException {
      super(buffer, transactionVersion);
  ...
  class ColoredCoinsAssetIssuance extends AbstractAttachment {
    ...
    ColoredCoinsAssetIssuance(ByteBuffer buffer, byte transactionVersion) throws CaretException.NotValidException {
      super(buffer, transactionVersion);
  ...
  final class ColoredCoinsAssetTransfer extends AbstractAttachment {
    ...
    ColoredCoinsAssetTransfer(ByteBuffer buffer, byte transactionVersion) throws CaretException.NotValidException {
      super(buffer, transactionVersion);
  ...
  final class DigitalGoodsListing extends AbstractAttachment {
    ...
    DigitalGoodsListing(ByteBuffer buffer, byte transactionVersion) throws CaretException.NotValidException {
      super(buffer, transactionVersion);
  ...
  final class DigitalGoodsDelivery extends AbstractAttachment {
    ...
    DigitalGoodsDelivery(ByteBuffer buffer, byte transactionVersion) throws CaretException.NotValidException {
      super(buffer, transactionVersion);
  ...
  final class CaretMiningRewardRecipientAssignment extends AbstractAttachment {

    CaretMiningRewardRecipientAssignment(ByteBuffer buffer, byte transactionVersion) {
      super(buffer, transactionVersion);
    }

    CaretMiningRewardRecipientAssignment(JSONObject attachmentData) {
      super(attachmentData);
    }

    public CaretMiningRewardRecipientAssignment(int blockchainHeight) {
      super(blockchainHeight);
    }
    ...
    @Override
    public TransactionType getTransactionType() {
      return TransactionType.CaretMining.REWARD_RECIPIENT_ASSIGNMENT;
    }
  }
  ...
  final class AdvancedPaymentEscrowCreation extends AbstractAttachment {
    ...
    AdvancedPaymentEscrowCreation(ByteBuffer buffer, byte transactionVersion) throws CaretException.NotValidException {
      super(buffer, transactionVersion);
      ...
      if(totalSigners > 10 || totalSigners <= 0) {
        throw new CaretException.NotValidException("Invalid number of signers listed on create escrow transaction");
      }
      for(int i = 0; i < totalSigners; i++) {
        if(!this.signers.add(buffer.getLong())) {
          throw new CaretException.NotValidException("Duplicate signer on escrow creation");
        }
      }
    }

    AdvancedPaymentEscrowCreation(JSONObject attachmentData) throws CaretException.NotValidException {
      super(attachmentData);
    ...
    public AdvancedPaymentEscrowCreation(Long amountNQT, int deadline, Escrow.DecisionType deadlineAction,
                                         int requiredSigners, Collection<Long> signers, int blockchainHeight) throws CaretException.NotValidException {
      super(blockchainHeight);
  ...
  final class AutomatedTransactionsCreation extends AbstractAttachment{
    ...
    AutomatedTransactionsCreation(ByteBuffer buffer,
                                  byte transactionVersion) throws CaretException.NotValidException {
      super(buffer, transactionVersion);
      ...
      int pageSize = ( int ) AT_Constants.getInstance().PAGE_SIZE( Caret.getBlockchain().getHeight() );
