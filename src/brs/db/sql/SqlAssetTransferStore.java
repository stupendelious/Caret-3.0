...
public class SqlAssetTransferStore implements AssetTransferStore {
  ...
  protected static final CaretKey.LongKeyFactory<AssetTransfer> transferDbKeyFactory = new DbKey.LongKeyFactory<AssetTransfer>("id") {

      @Override
      public CaretKey newKey(AssetTransfer assetTransfer) {
  ...
  @Override
  public CaretKey.LongKeyFactory<AssetTransfer> getTransferDbKeyFactory() {
  ...
  @Override
  public CaretIterator<AssetTransfer> getAccountAssetTransfers(long accountId, int from, int to) {
