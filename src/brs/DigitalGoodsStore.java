...
public final class DigitalGoodsStore {
  ...
  public static class Goods {
    ...
    private static final CaretKey.LongKeyFactory<Goods> goodsDbKeyFactory() {
      return Caret.getStores().getDigitalGoodsStoreStore().getGoodsDbKeyFactory();
    }

    private static final VersionedEntityTable<Goods> goodsTable() {
      return Caret.getStores().getDigitalGoodsStoreStore().getGoodsTable();
    }
    ...
    protected Goods(long id, CaretKey dbKey, long sellerId, String name, String description, String tags, int timestamp,
    ...
    public Goods(CaretKey dbKey, Transaction transaction, Attachment.DigitalGoodsListing attachment) {
      this.dbKey = dbKey;
  ...
  public static class Purchase {
    ...
    private static final CaretKey.LongKeyFactory<Purchase> purchaseDbKeyFactory() {
      return Caret.getStores().getDigitalGoodsStoreStore().getPurchaseDbKeyFactory();
    }

    private static final CaretKey.LongKeyFactory<Purchase> feedbackDbKeyFactory() {
      return Caret.getStores().getDigitalGoodsStoreStore().getFeedbackDbKeyFactory();
    }

    private static final VersionedValuesTable<Purchase, EncryptedData> feedbackTable() {
      return Caret.getStores().getDigitalGoodsStoreStore().getFeedbackTable();
    }

    private static final CaretKey.LongKeyFactory<Purchase> publicFeedbackDbKeyFactory() {
      return Caret.getStores().getDigitalGoodsStoreStore().getPublicFeedbackDbKeyFactory();
    }

    private static final VersionedValuesTable<Purchase, String> publicFeedbackTable() {
      return Caret.getStores().getDigitalGoodsStoreStore().getPublicFeedbackTable();
    }
    ...
    protected Purchase(long id, CaretKey dbKey, long buyerId, long goodsId, long sellerId, int quantity,
