...
abstract class CreateTransaction extends APIServlet.APIRequestHandler {
  ...
  final JSONStreamAware createTransaction(HttpServletRequest req, Account senderAccount, Long recipientId, long amountNQT, Attachment attachment) throws CaretException {
  ...
  long minimumFeeNQT() {
    return Caret.getFluxCapacitor().isActive(PRE_DYMAXION) ? FEE_QUANT : ONE_CARET;
  }
