...
public class GetDGSGoodsTest extends AbstractUnitTest {
  ...
  @Test
  public void processRequest_getSellerGoods() throws CaretException {
    ...
    final CaretIterator<Goods> mockGoodIterator = mockCaretIterator(mockGood);
  ...
  @Test
  public void processRequest_getAllGoods() throws CaretException {
  ...
  @Test
  public void processRequest_getGoodsInStock() throws CaretException {
    final long sellerId = 0L;
    final int firstIndex = 2;
    final int lastIndex = 3;
