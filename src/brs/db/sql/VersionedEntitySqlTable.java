...
public abstract class VersionedEntitySqlTable<T> extends EntitySqlTable<T> implements VersionedEntityTable<T> {
  ...
  protected VersionedEntitySqlTable(String table, TableImpl<?> tableClass, CaretKey.Factory<T> dbKeyFactory, DerivedTableManager derivedTableManager) {
  ...
  public boolean delete(T t) {
    ...
    try ( DSLContext ctx = Db.getDSLContext() ) {
      ...
      countQuery.addConditions(tableClass.field("height", Integer.class).lt(Caret.getBlockchain().getHeight()));
