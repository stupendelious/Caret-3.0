...
public class BlockchainImpl implements Blockchain {
  ...
  @Override
  public CaretIterator<Block> getBlocks(Account account, int timestamp) {
  ...
  @Override
  public CaretIterator<Transaction> getTransactions(Account account, byte type, byte subtype, int blockTimestamp) {
