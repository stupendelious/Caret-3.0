...
/**
 * Handle logging for the Caret node server
 */
...
public final class LoggerConfigurator {
  ...
  static {
    ...
    System.setProperty("java.util.logging.manager", "brs.util.CaretLogManager");
    if (!(LogManager.getLogManager() instanceof CaretLogManager)) {
  ...
  public static void shutdown() {
    if (LogManager.getLogManager() instanceof CaretLogManager) {
      ((CaretLogManager) LogManager.getLogManager()).caretShutdown();
    }
  }
