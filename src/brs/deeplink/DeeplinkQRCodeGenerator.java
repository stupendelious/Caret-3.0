...
public class DeeplinkQRCodeGenerator {
  ...
  private static final String OVERLAY_LOCATION = "resources/images/caret_overlay_logo.png";
  ...
  public BufferedImage generateRequestCaretDeepLinkQRCode(String receiverId, long amountNQT, FeeSuggestionType feeSuggestionType, Long feeNQT, String message, boolean immutable)
      throws WriterException {
    final StringBuilder deeplinkBuilder = new StringBuilder("caret://requestCaret");
    ...
    return generateCaretQRCode(deeplinkBuilder.toString());
  }

  private BufferedImage generateCaretQRCode(String url) throws WriterException {
