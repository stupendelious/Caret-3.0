...
public abstract class AbstractTransactionTest extends AbstractUnitTest {
  ...
  public interface TransactionCreationFunction<R> {
    R apply() throws CaretException;
  }

  protected Attachment attachmentCreatedTransaction(TransactionCreationFunction r, APITransactionManager apiTransactionManagerMock) throws CaretException {
