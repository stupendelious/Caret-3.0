...
public class GetAccountEscrowTransactionsTest extends AbstractUnitTest {
  ...
  public void processRequest() throws CaretException {
    ...
    final CaretIterator<Decision> decisionsIterator = mockCaretIterator(decision, skippedDecision, otherSkippedDecision);
    ...
    assertEquals("CARET-2228-2222-BMNG-22222", result.get(SENDER_RS_RESPONSE));
    assertEquals("" + escrow.getRecipientId(), result.get(RECIPIENT_RESPONSE));
    assertEquals("CARET-2227-2222-ZAYB-22222", result.get(RECIPIENT_RS_RESPONSE));
    ...
    assertEquals("CARET-2225-2222-QVC9-22222", signer.get(ID_RS_RESPONSE));
