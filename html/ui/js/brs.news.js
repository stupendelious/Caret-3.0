...
var BRS = (function(BRS, $, undefined) {
	...
	if (currentTime - BRS.newsRefresh > 60 * 60 * 10) { //10 minutes before refreshing..
		...
		"filter": function(entry, tokens) {
		    return tokens.title.indexOf("Donations toward") == -1 && tokens.title.indexOf("CARET tipping bot has arrived") == -1;
		}
	    };

	    $("#caretforum_news").rss("https://forums.getcaret.net/c/caret-community-announcements", settings, BRS.newsLoaded);
	    $("#caretforum2_news").rss("https://caretforum.net/category/1/announcements", settings, BRS.newsLoaded);		
	    $("#reddit_news").rss("http://www.reddit.com/r/caretcoin/.rss", settingsReddit, BRS.newsLoaded);
	    $("#caretcoinist_news").rss("https://www.caretcoin.ist/category/articles/", settings, BRS.newsLoaded);
	}
