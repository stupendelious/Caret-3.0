...
public class SqlBlockDb implements BlockDb {
  ...
  public Block loadBlock(DSLContext ctx, ResultSet rs)
      throws CaretException.ValidationException {
    try {
  ...
  public Block loadBlock(BlockRecord r) throws CaretException.ValidationException {
  ...
  public void saveBlock(DSLContext ctx, Block block) {
    ...
    Caret.getDbs().getTransactionDb().saveTransactions(block.getTransactions());
