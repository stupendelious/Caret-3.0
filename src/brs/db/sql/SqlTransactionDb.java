...
public class SqlTransactionDb implements TransactionDb {
  ...
  @Override
  public Transaction loadTransaction(TransactionRecord tr) throws CaretException.ValidationException {
    if (tr == null) {
      return null;
    }
  ...
  @Override
  public Transaction loadTransaction(DSLContext ctx, ResultSet rs) throws CaretException.ValidationException {
