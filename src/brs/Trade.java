...
public class Trade {
  ...
  public Trade(int timestamp, long assetId, long blockId, int height,
               ...
               long sellerId, long buyerId, CaretKey dbKey, long quantityQNT, long priceNQT) {
  ...
  public Trade(CaretKey dbKey, long assetId, Block block, Order.Ask askOrder, Order.Bid bidOrder) {
    this.dbKey = dbKey;
