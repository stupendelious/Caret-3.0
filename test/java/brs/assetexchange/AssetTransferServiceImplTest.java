...
public class AssetTransferServiceImplTest {
  ...
  public void getAssetTransfers() {
    ...
    final CaretIterator<AssetTransfer> mockAssetTransferIterator = mock(CaretIterator.class);
  ...
  public void getAccountAssetTransfers() {
    ...
    final CaretIterator<AssetTransfer> mockAccountAssetTransferIterator = mock(CaretIterator.class);
