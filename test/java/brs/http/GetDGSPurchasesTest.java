...
public class GetDGSPurchasesTest extends AbstractUnitTest {
  ...
  @Test
  public void processRequest_getAllPurchases() throws CaretException {
    ...
    CaretIterator<Purchase> mockGoodsIterator = mockCaretIterator(mockPurchase);
  ...
  @Test
  public void processRequest_getSellerPurchases() throws CaretException {
    final HttpServletRequest req = QuickMocker.httpServletRequest(
  ...
  @Test
  public void processRequest_getBuyerPurchases() throws CaretException {
    final HttpServletRequest req = QuickMocker.httpServletRequest(
        new MockParam(SELLER_PARAMETER, 0),
  ...
  @Test
  public void processRequest_getSellerBuyerPurchases() throws CaretException {
    final HttpServletRequest req = QuickMocker.httpServletRequest(
        new MockParam(SELLER_PARAMETER, 1),
