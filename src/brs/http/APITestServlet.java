...
public class APITestServlet extends HttpServlet {
  ...
  private static final String header1 =
      ...
      + "            })\n"
      + "            .fail(function() {\n"
      + "                alert('API not available, check if Caret Server is running!');\n"
      + "            });\n"
      ...
      + "           <a class=\"navbar-brand\" href=\"/test\">Caret http API</a>"
      + "       </div>"
      + "       <div class=\"navbar-collapse collapse\">"
      + "           <ul class=\"nav navbar-nav navbar-right\">"
      + "               <li><input type=\"text\" class=\"form-control\" id=\"search\" "
      + "                    placeholder=\"Search\" style=\"margin-top:8px;\"></li>\n"
      + "               <li><a href=\"https://caretwiki.org/wiki/The_Caret_API\" target=\"_blank\" style=\"margin-left:20px;\">Wiki Docs</a></li>"
  ...
  private static String form(String requestType, boolean singleView, String className, List<String> parameters, boolean requirePost) {
    ...
    buf.append("<form action=\"/caret\" method=\"POST\" onsubmit=\"return submitForm(this);\">");
