...
class ReservedBalanceCache {
  ...
  void reserveBalanceAndPut(Transaction transaction) throws CaretException.ValidationException {
    ...
    if (senderAccount == null) {
      ...
      throw new CaretException.NotCurrentlyValidException("Account unknown");
      ...
      throw new CaretException.NotCurrentlyValidException("Insufficient funds");
    }
