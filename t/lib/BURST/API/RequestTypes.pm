...
package CARET::API::RequestTypes;
...
my $CGPX = 'tag:caret.cryptoguru.org,2018:rx'; # own CG prefix
...
our $reqtypes = [ # we want to define a sequence of tests
    ...
    # {{{ getAccount
     {
         ...
         required => {
             accountRS => {
                 type => '//str',
                 value => 'CARET-DPQM-9X88-LEU3-CNSST',
             },
             account => {
                 type => '//int',
         ...
         args => {
             account => 'CARET-DPQM-9X88-LEU3-CNSST'
         },
     },
    # }}}
...

    {
        ...
        required => {
            ...
            totalEffectiveBalanceNXT => '/brs/balanceCARET',
    ...
    # {{{ rsConvert
    {
        ...
        required => {
            accountRS => {
                type => '//str',
                value => "CARET-EMXC-3PFB-J8HQ-GJ9HZ",
            },
            account => {
                    type => '//int',
