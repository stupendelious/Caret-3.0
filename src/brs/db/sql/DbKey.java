...
public interface DbKey extends CaretKey {

  abstract class Factory<T> implements CaretKey.Factory<T> {
    ...
    public abstract CaretKey newKey(T t);

    public abstract CaretKey newKey(ResultSet rs);
  ...
  abstract class LongKeyFactory<T> extends Factory<T> implements CaretKey.LongKeyFactory<T> {
    ...
    @Override
    public CaretKey newKey(ResultSet rs) {
      try {
    ...
    public CaretKey newKey(long id) {
  ...
  abstract class LinkKeyFactory<T> extends Factory<T> implements CaretKey.LinkKeyFactory<T> {
    ...
    public CaretKey newKey(long idA, long idB) {
