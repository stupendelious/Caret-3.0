...
public final class Convert {
  ...
  public static String rsAccount(long accountId) {
    return "CARET-" + Crypto.rsEncode(accountId);
  }
  ...
  public static String readString(ByteBuffer buffer, int numBytes, int maxLength) throws CaretException.NotValidException {
    if (numBytes > 3 * maxLength) {
      throw new CaretException.NotValidException("Max parameter length exceeded");
    }
  ...
  public static long parseNXT(String nxt) {
    return parseStringFraction(nxt, 8, Constants.MAX_BALANCE_CARET);
  }
