...
public interface DGSGoodsStoreService {
  ...
  CaretIterator<Goods> getAllGoods(int from, int to);

  CaretIterator<Goods> getGoodsInStock(int from, int to);

  CaretIterator<Goods> getSellerGoods(long sellerId, boolean inStockOnly, int from, int to);

  CaretIterator<Purchase> getAllPurchases(int from, int to);

  CaretIterator<Purchase> getSellerPurchases(long sellerId, int from, int to);

  CaretIterator<Purchase> getBuyerPurchases(long buyerId, int from, int to);

  CaretIterator<Purchase> getSellerBuyerPurchases(long sellerId, long buyerId, int from, int to);

  CaretIterator<Purchase> getPendingSellerPurchases(long sellerId, int from, int to);
  ...
  CaretIterator<Purchase> getExpiredPendingPurchases(int timestamp);
