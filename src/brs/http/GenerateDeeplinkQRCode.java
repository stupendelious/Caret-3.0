...
public class GenerateDeeplinkQRCode extends PrimitiveRequestHandler {
  ...
  public void processRequest(HttpServletRequest req, HttpServletResponse resp) {
    try {
      ...
      final BufferedImage qrImage = deeplinkQRCodeGenerator.generateRequestCaretDeepLinkQRCode(receiverId, amountNQT, feeSuggestionType, feeNQT, message, immutable);
