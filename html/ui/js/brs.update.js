...
var BRS = (function(BRS, $, undefined) {
        ...
        if (BRS.inApp) {
            if (BRS.appPlatform && BRS.appVersion) {
                ...
                if (new Date() > noticeDate) {
                    ...
                    var downloadUrl = "https://github.com/PoC-Consortium/caretcoin/releases";
    ...
    BRS.downloadClientUpdate = function(version) {
        ...
        if (BRS.inApp) {
            ...
            $("#brs_update_iframe").attr("src", "https://github.com/PoC-Consortium/caretcoin/releases/download/" + BRS.downloadedVersion.versionNr + "/caretcoin-" + BRS.downloadedVersion.versionNr + ".zip");
