...
public class AssetExchangeImpl implements AssetExchange {
  ...
  @Override
  public CaretIterator<AccountAsset> getAccountAssetsOverview(long id, int height, int from, int to) {
  ...
  @Override
  public CaretIterator<Ask> getAskOrdersByAccountAsset(long accountId, long assetId, int from, int to) {
  ...
  @Override
  public CaretIterator<Bid> getBidOrdersByAccountAsset(long accountId, long assetId, int from, int to) {
