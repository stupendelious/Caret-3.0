...
public class TradeServiceImplTest extends AbstractUnitTest {
  ...
  public void getAssetTrades() {
    ...
    final CaretIterator<Trade> mockTradesIterator = mock(CaretIterator.class);
  ...
  public void getAccountAssetTrades() {
    ...
    final CaretIterator<Trade> mockAccountAssetTradesIterator = mock(CaretIterator.class);
  ...
  public void getAllTrades() {
    ...
    final CaretIterator<Trade> mockTradeIterator = mockCaretIterator();
