...
public class DGSGoodsStoreServiceImplTest extends AbstractUnitTest {
  ...
  public void getAllGoods() {
    ...
    final CaretIterator<DigitalGoodsStore.Goods> mockIterator = mockCaretIterator();
  ...
  public void getAllPurchases() {
    ...
    final CaretIterator<DigitalGoodsStore.Purchase> mockIterator = mockCaretIterator();
  ...
  public void getPendingSellerPurchases() {
    ...
    CaretIterator<Purchase> mockPurchaseIterator = mockCaretIterator();
