...
public class Escrow {
  ...
  public static class Decision {
    ...
    public Decision(CaretKey dbKey, Long escrowId, Long accountId, DecisionType decision) {
      this.dbKey = dbKey;
  ...
  public Escrow(CaretKey dbKey, Account sender,
      Account recipient,
      Long id,
      Long amountNQT,
      int requiredSigners,
  ...
  protected Escrow(Long id, Long senderId, Long recipientId, CaretKey dbKey, Long amountNQT,
  ...
  public CaretIterator<Decision> getDecisions() {
    return Caret.getStores().getEscrowStore().getDecisions(id);
  }
