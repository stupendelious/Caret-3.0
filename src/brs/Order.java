...
public abstract class Order {
  ...
  public static class Ask extends Order {
    ...
    public Ask(CaretKey dbKey, Transaction transaction, Attachment.ColoredCoinsAskOrderPlacement attachment) {
      super(transaction, attachment);
      this.dbKey = dbKey;
    }

    public Ask(long id, long accountId, long assetId, long priceNQT, int creationHeight, long quantityQNT, CaretKey dbKey) {
  ...
  public static class Bid extends Order {
    ...
    public Bid(CaretKey dbKey, Transaction transaction, Attachment.ColoredCoinsBidOrderPlacement attachment) {
      super(transaction, attachment);
      this.dbKey = dbKey;
    }

    public Bid(long id, long accountId, long assetId, long priceNQT, int creationHeight, long quantityQNT, CaretKey dbKey) {
      super(id, accountId, assetId, priceNQT, creationHeight, quantityQNT);
      this.dbKey = dbKey;
    }
  }
