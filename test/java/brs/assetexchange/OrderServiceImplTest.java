...
public class OrderServiceImplTest {
  ...
  public void getAskOrder() {
    final CaretKey mockAskKey = mock(CaretKey.class);
  ...
  public void getBidOrder() {
    final CaretKey mockBidKey = mock(CaretKey.class);
  ...
  public void getAllAskOrders() {
    ...
    final CaretIterator<Ask> mockAskIterator = mock(CaretIterator.class);
  ...
  public void getAllBidOrders() {
    ...
    final CaretIterator<Bid> mockBidIterator = mock(CaretIterator.class);
